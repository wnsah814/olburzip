    ...
    <div className="media-controls">
      ...
      <div className="media-top">
        <button className="media-button" onClick={previous}>
          <FontAwesomeIcon style={{ color: "#131212" }} icon={faAngleLeft} />
        </button>
        <div>{title}</div>
        <button className="media-button" onClick={next}>
          <FontAwesomeIcon style={{ color: "#131212" }} icon={faAngleRight} />
        </button>
      </div>
      <div className="media-buttons">
        {looped ? (
          <button className="repeat-one-button media-button" onClick={loop}>
          ...
          <button className="repeat-no-button media-button" onClick={loop}>
            <i className="button-icons">
              <svg
                className="button-3"
                xmlns="http://www.w3.org/2000/svg"
        ...
        <button className="rewind-button media-button" onClick={backward}>
          <i className="button-icons">
            <svg
              className="button-2"
              xmlns="http://www.w3.org/2000/svg"
        ...
        {active ? (
          <button className="play-button media-button" onClick={pause}>
            <i className="button-icons">
              <svg
                className="button-1"
                xmlns="http://www.w3.org/2000/svg"
        ...
        <button className="fast-forward-button media-button" onClick={forward}>
          <i className="button-icons">
            <svg
              className="button-2"
              xmlns="http://www.w3.org/2000/svg"
        ...
        <div
          id="volum-wrapper"
          onMouseEnter={() => {
            document.querySelector<any>("#volume-range").style.visibility =
              "visible";
          }}
          onMouseLeave={() => {
            document.querySelector<any>("#volume-range").style.visibility =
        ...
        >
          ...
          />
          {volume === 0 ? (
            <button id="volume-button" className="shuffle-button media-button">
              <i className="button-icons">
                <svg
                  className="button-3"
                  xmlns="http://www.w3.org/2000/svg"
      ...
      <div className="media-progress">
        ...
        <div className="progress-time-current">
          {`${musicRealTime === undefined ? "0:00" : fmtMSS(musicRealTime)}`}
        </div>
