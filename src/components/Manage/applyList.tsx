...
const ApplyList = () => {
  ...
  useEffect(() => {
    if (aYear === 0) return;
    console.log("aYear", aYear, "aSem", aSem);
    const q = query(
      collection(dbService, `applies`),
      where("year", "==", aYear),
      where("semester", "==", aSem),
  ...
  const allowAll = async () => {
    ...
    collectionRef.forEach((v) => {
      ...
      updateDoc(doc(dbService, `applies`, v.id), {
        allowed: true,
      });
      setDoc(doc(dbService, `members`, v.id), {
        name: v.data().name,
                  ...
                  <div key={i} className={styles.card}>
                    ...
                    <div className={styles.card_item}>
                      <div className={styles.card_column}>
                        ...
                        <span className={styles.card_content}>{v?.name}</span>
                      </div>
                      <div className={styles.card_column}>
                    ...
                    <div className={styles.card_item}>
                      ...
                      <div className={styles.card_column}>
                        ...
                        <span className={styles.card_content}>{v?.mbti}</span>
                      </div>
                    </div>
                    <div className={styles.card_item}>
