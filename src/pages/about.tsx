    ...
    return (
        <>
            ...
            {/* <div className={styles.letter}>
                <p>환영합니다.</p>
                <p>한양대학교 컴퓨터소프트웨어학부 율동패 어리버리입니다.</p>
                <p>"Was mich nicht umbringt, macht mich stärker."</p>
                <p>
                    2002년 동아리가 결성된 이래로, 처음 팬데믹을 겪으며 동아리
                    운영에 어려운 시간을 보내었습니다.
                </p>
                <p>그럼에도 우리는 결국 죽지 않고 돌아왔습니다.</p>
                <p>
                    올 한해, 한동안 이루지 못 했던 추억까지 여러분과 함께 만들어
                    나가겠습니다.
                </p>
                <p>Copyright for 어리버리 all rights reserved.</p>
            </div> */}
            <div className={styles.container}>
                ...
                <p>
                    코로나로 인한 공백기도 채워줄 수 있는 선배들도 친구처럼 지낼
                    수 있어요!
                </p>
                ...
                <ul>
                    <li>
                        ☑️ 유머 넘치는 최강 인싸 선배들과 함께 즐겁고 흥 넘치는
                        대학생활을 만들고 싶다면!
                    </li>
            ...
            <div className={styles.container}>
                ...
                <p>
                    시험 몇주전에는 슬프게도 회합이 없답니다🥲 공부할 땐 하는
                    사람들이거든요🔥
                </p>
                ...
                {/* <span>
                    \\wsl.localhost\Ubuntu\home\wnsah814\urburzip\public\assets\img\about
                </span> */}
                <div className={`${styles.imgs} ${styles.img}`}>
                    <img
                        className={`${styles.img43} ${styles.img}`}
            ...
            <div className={styles.container}>
                ...
                <h3>가을 엠티</h3>
                <p>
                    파티룸! 노래도 부르고 당구도 치고 여러가지 놀이를 즐겼죠..
                    아 또 가고 싶다
                </p>
                <div className={`${styles.imgs} ${styles.img}`}>
                    <img
            ...
            <div className={styles.container}>
                ...
                <p>
                    22년 5월 24일에는 공학인의 밤 행사에 참여해 그동안 연습한
                    율동을 선보였습니다!
                </p>
                <p>
                    율동으로는 꿈찾기, 날자를 준비했고, 얼탄소년단(UTS)의 DNA
                    무대도 진행되었어요
                </p>
            ...
            <div className={styles.container}>
                ...
                <p>
                    카드놀이 하다보니 시간 삭제 🥲 사진도 많이 많이 찍고 너무
                    기억에 남아요
                </p>
