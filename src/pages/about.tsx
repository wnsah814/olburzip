  ...
  return (
    <>
      ...
      <div className={styles.container}>
        ...
        >
          <p>
            공대에서 여러 학부들이 운영하는 율동패 중 컴퓨터소프트웨어학부
            동아리로 율동을 배우고 공연을 준비합니다.
          </p>
          <p>
            새준단(공대판), 공학인의 밤, 축제, 컴소인의 밤 등의 여러 행사에서
            공연을 준비해요.
          </p>
        ...
        >
          <ul className={styles.ul}>
            <li>율동이 부담스럽다고요?🤔</li>
            <li>
              ➡️누구나 배울 수 있는 쉬운 동작과 중독성 있는 노래로 부담없이 즐길
              수 있는 대학생 버전 율동입니다!
            </li>
            <li>율동만 하나고요?🤔</li>
            <li>
              ➡️ 원한다면 다른 춤 공연도 준비합니다! 케이팝 무대도 많이 했었으니
              마음껏 끼를 뽐내주세요!
            </li>
            <li>어려울 것 같다고요?🤔</li>
            <li>➡️몸치? 박치? 오히려 인재입니다. 지금 신청하시죠.</li>
          </ul>
        </div>
        <br />
        ...
        >
          ...
          <p>
            코로나로 인한 공백기도 채워줄 수 있는 선배들도 친구처럼 지낼 수
            있어요!
          </p>
        ...
        >
          <ul>
            <li>
              ☑️ 유머 넘치는 최강 인싸 선배들과 함께 즐겁고 흥 넘치는 대학생활을
              만들고 싶다면!
            </li>
      ...
      <div className={styles.container}>
        ...
        <div data-aos="fade-in">
          ...
          <p>
            (아쉽게도 시험 몇주전에는 회합이 없답니다🥲 공부할 땐 하는
            사람들이거든요🔥)
          </p>
        </div>

        <div data-aos="fade-in" className={`${styles.imgs} ${styles.img}`}>
          <img
      ...
      <div className={styles.container}>
        ...
        <div data-aos="fade-in">
          ...
          <p>봄에는 대성리에 갔어요! </p>
          <p>
            다같이 고기도 먹고... 술게임도 배우고... 폭죽도 날리고... 낭만 그
            자체...{" "}
          </p>
        ...
        <div data-aos="fade-in">
          ...
          <p>
            가을에는 파티룸에 갔어요! 배달음식 먹어 배를 채우고 신나게
            놀았답니당
          </p>
          <p>
            {" "}
            노래도 부르고 당구도 치고 임원진이 준비한 게임도 다같이 즐겼어요!
          </p>
          <p>올해도 갈 예정이라죠~?</p>
      ...
      <div className={styles.container}>
        ...
        <div data-aos="fade-in">
          <p>
            22년 5월 24일에는 공학인의 밤 행사에 참여해 그동안 연습한 율동을
            선보였습니다!
          </p>
          <p>
            율동으로는 꿈찾기, 날자를 준비했고, 얼탄소년단(UTS)의 DNA 무대도
            진행되었어요
          </p>
        </div>
      ...
      <div className={styles.container}>
        ...
        <div data-aos="fade-in">
          <p>
            얼벌은 동아리 회합때만이 아니라 이외의 시간에도 만나서 놀아요. 진짜
            모두가 찐친.
          </p>
        </div>
        ...
        <div data-aos="fade-in">
          <h3>서울숲</h3>
          <p>
            초반의 어색함이 남아 있을 때 날씨가 너무좋아서 같이 산책을
            다녀왔어요.
          </p>
          <p>
            카드놀이 하다보니 시간 삭제 🥲 사진도 많이 많이 찍고 너무 기억에
            남아요
          </p>
        ...
        <div data-aos="fade-in">
          <h3>컴소인의 밤</h3>
          <p>코로나로 인해 하지못한 컴소인의 밤이 이번년도에 부활한다해요!</p>
          <p>2학기에도 식지 않는 열정을 보여줍시다!</p>
          <br />
          <p>이렇게 보니.. 지원하지 않으면 손해겠는데요? 신청좀 하고 올게요</p>
          <Button>
