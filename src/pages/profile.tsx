  ...
  return (
    <>
      ...
      <div className={styles.wrapper}>
        ...
        <div data-aos="fade-up" data-aos-delay="600" className={styles.card}>
          ...
          <div>
            ...
            <div className={styles.desc}>
              ...
              <span>
                {levelArr[level]}
                {level === 0 && (
                  <span className={styles.applyBtn} onClick={requestLevelUp}>
                    얼벌인 신청
                  </span>
                )}
              </span>
          ...
          <div>
            <img id={styles.backLogo} src="/assets/img/logo.svg" alt="logo" />
          </div>
        </div>
      </div>
    </>
